...
program => q!
    ...
    !,
expected => [
    qq!cmoc: --org and --data are not permitted for Vectrex!,
    ]
},
...
program => q!
    ...
    !,
expected => [
    qq!,check-prog.c:7: __error__: true and false expressions of conditional are of incompatible types (char * vs int)!,
    qq!,check-prog.c:8: __warning__: true and false expressions of conditional are not of the same type (char vs int); result is of type int!,
    qq!,check-prog.c:10: __warning__: true and false expressions of conditional are not of the same type (int vs unsigned char); result is of type int!,
    ]
},
...
expected => [
    ...
    qq!,check-prog.c:4: __error__: `f' in initializer would make program non-relocatable (see --no-relocate)!,
    ]
},
...
expected => [
    ...
    qq!,check-prog.c:2: __error__: empty declarator name!,
    qq!,check-prog.c:3: __error__: empty typename name!,
    qq!,check-prog.c:4: __error__: empty typename name!,
    qq!,check-prog.c:4: __error__: empty typename name!,
    qq!,check-prog.c:5: __error__: empty typename name!,
    qq!,check-prog.c:5: __error__: empty typename name!,
...
sub runTestNumber
{
    ...
    #{
    #    print "$0: ERROR: program #$i: did not get expected number of errors\n";
    #    return 0;
    #}
